...
const path = __importStar(__nccwpck_require__(17));
function createGrafanaAnnotation(host, token, annotation) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resp = yield client.postJson(apiUrl, body, headers);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resp = yield createGrafanaAnnotation(grafanaHost, grafanaToken, annotation);
